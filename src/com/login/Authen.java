...
public class Authen {
     ...
     */
 static final String username = "deadmin"; // your account name
    static final String password = "teamworks"; // your password for the account
    ...
    public void sendPostRequest() {
        ...
        try {
            ...
            // Send the request
            URL url = new URL("https://10.10.7.150:9443/rest/bpm/wle/v1/task/7154?parts=all");
